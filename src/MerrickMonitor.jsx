...
const MerrickMonitor = () => {
  ...
  const loadGitHubData = async () => {
    ...
    try {
      ...
      const response = await fetch("/MerrickMonitor/data/github-data.json");
      if (response.ok) {
        const data = await response.json();
        setToolFleet(data.toolFleet || []);
        setArchivedRepos(data.archived || []);
        console.log(`✅ Loaded GitHub data (updated: ${data.lastUpdated})`);
      } else {
        console.error("Failed to load GitHub data:", response.status);
